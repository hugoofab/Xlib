...
//    )
    ...
    protected $field            = "";
    protected $label            = "";
    protected $template         = ' UPPER($this->field) = UPPER(\'$value\') ';
    protected $prefix           = "";
    protected $sufix            = "";
    ...
    public function formatQueryFilter ( ) {
        $value = Xlib_Request::get($this->filterContainer."[".$this->field."]");
...
//        setcookie($this->filterContainer.'['.$this->field.']', null, -1, '/');
    ...
    public function isDisabled ( ) {
        if ( !empty ( $this->data ) ) $data = $this->data ; // só para conveniencia do programador ;)
    ...
    public function __toString ( ) {
        ...
        if ( !empty ( $this->pre ) ) $output .= $this->pre;
        return $output;
